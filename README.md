...
자기 자신을 귀한 자산으로 여기고 자신의 능력을 키우는 데에 날카롭게 초점을 맞추세요. 자신의 능력을 널리 알리는 데에 모든 노력을 다하세요. 누구에게도 의존하지 않고 당신만큼 성숙한 사람과 손을 잡기 원한다면, 돈이 흘러들어오게 만드는 사람이 되어야 합니다. 이 이야기가 모든 동생들에게 힘과 용기가 되길 바랍니다.

많이 힘드셨나봅니다. 지금 하신 그 말씀 가장 많이 듣게 됩니다. 사실 살고싶은 데 살아야할 이유를 찾기가 너무힘든 순간. 두가지 마음이 다 든다고 하십니다. 양가감정이라고 부르는 것같습니다. 어떤 힘든 상황에 계신지 알지 못하지만 때로 우울이라는 마음으로 보면 살아야할 이유가 보이지 않습니다. 내가 지금 우울한 상태라면 그것부터 있는 그대로 받아들이는데서 새로운 것을 보게 되더라는 분들을 만나게 됩니다. 지금은 미래가 상상하기 어렵겠지만 큰 결정은 미뤄두실수 있으면 좋겠습니다. 우울증치료를 끝내는 좋은 날 우울증이 없었으면 가장 좋았겠지만 뭔가 도움이 되셨냐고 물으면 모든 분들이 얻은 게 있다고 하십니다. 그게 사람이던 일이던 취미던 힘들때는 그런 나의 삶이 있는게 보이지 않았다고 하십니다. 그런 미래를 함께 찾아볼수 있으면 좋겠습니다.

홍진경은 참 안타까운데 노력하는 방식의 문제라고 생각함
홍진경이 잘못했다는게 아니라 모르면 저렇게 될 수 밖에 없음
이건 진짜 내가 인생의 깨달음을 얻은 이야긴데
시간 되는 사람은 읽어보셈

예전에 밤비노 라는 드라마가 있었는데
요리 안해본 애가 파스타 집 쉐프로 일 배워서 성공하는 드라마였음
처음하니까 엉망진창이고 당연히 실수연발
엄청 혼나고 엄청 우울해 하다가
이정도로 포기 할 수 없지! 열심히 해보자! 라고 각오를 다짐
그리고 선물 받은 개인 칼을 갈고 식자재 써는 연습을 하려고 함

여기서 중요한건 주인공 포지션이 주방 보조라는 거임
봉골레 파스타 주문 들어오면 냉장고에서 조개 꺼내주고
소스 떨어지면 리필해주고 그런 일을 하는거
그런데 파스타 이름 듣고 재료가 뭔지 모르니까
뭐 가져오라고 소리쳐야 냉장고 가서 하나 가져오는데
파스타 파트만 사람이 2,3명 되고 주문이 폭주하는 상황이라
아무리 뛰어도 뛰어도 시간이 부족함
이런 상황을 극복하고 연습을 하고 싶다면
여기서 해야 하는 일은 파스타 레시피에 대한 공부임

파스타 이름만 듣고도 필요한 재료는 뭐가 있는지
냉장고에 있는 각 재료의 위치는 어디인지
파스타 1인분에 육수는 얼마나 들어가는지
몇인분의 파스타를 만들어야 육수통 리필이 필요한지
그걸 모르고 칼질 연습 아무리 해봐야 의미가 없음

노력을 하는 것은 좋은데 필요한 노력을 해라
필요 없는 노력을 하는 것은 그냥 자기만족이다
이런 이야기를 쉐프가 해 줌
주인공 거기서 깨달음을 얻고 그때부터 레시피 공부함
그리고 나서 주문 들어오면 말 안해도 재료 가져다 줌
육수통 1/3 정도 줄어들면 알아서 리필 척척 하기 시작함

홍진경 연습 열심히 했음 그건 진짜 인정
그런데 노력하는 방향에 문제가 있음
영상 뒷부분에 직원 2명 앞에 두고 연습하는 장면 계속 나오는데
저렇게 연습하면 춤을 추는 순서는 분명히 외울 수 있음
그런데 각 동작의 디테일이 점점 떨어짐
순서를 외웠다면 각 파트의 디테일을 살려서 느낌을 줘야 하는데
거울을 보지 않으면 자기 동작을 제대로 볼 수 없음
그런 상태에서 죽어라 연습해봐야 순서는 맞는데 이상한 춤이 됨
다운 그루브 동작 할 때 팔 올라가는게 그것 때문임
춤 순서를 외우는데 다운 그루브 동작이 안되서 진도가 안나가니까
다운그루브 동작을 배우고 그 뒤로 계속 순서만 반복한거임
안무가들이 춘 춤과 자신의 춤이 뭐가 다른지
왜 다른지 디테일을 따지면서 비교했다면
다운 그루브에서 팔 올라가는 동작은 수정을 했을거임
그런데 그대로 했다는 건 순서만 반복적으로 연습했다는 의미

티파니 딱봐도 잘하는데 왜 무릎꿇고 잘못했다고 했을까?
아이돌 한테 춤 순서 외우는거 일도 아님
순서는 다 외우고 있는데 디테일이나 느낌이 좀 떨어지는게 있고
그게 아이돌 기준에서는 완성도가 낮아서 연습 안됐다고 하는거
홍진경도 그럼 부분을 인지하고 노력하면 잘 할 수 있음
안타까운건 이 이야기를 해줄 사람이 옆에 없다는거

1. 우울감에 탐닉하지 말 것 
2. 가능성이 많은만큼 불안하다는 점을 상기할 것 
3. 잡생각 집어치우고 공부, 운동, 잠에 집중할 것 
...
how to study well 
https://www.youtube.com/watch?v=P2rpSiACoVQ

1 하루에 7.5시간 이상 공부하지 마라.
2 일주일에 하루는 쉬어라.
+완공 휴식은 해결의 열쇠. 제대로 된 노력은 휴식까지 포함
3 계획을 세워라. 각 과목에서 가장 중요한 지식을 찾아라
 각 학습 영역에서 가장 쉽게 50%를 먼저 얻을 계획이라고 상상해 계획을 세워라.
+완공 목표를 세워라. 
무엇을 해야하는지 알려줌 ->행동을 제대로 조직화
강력한 동기부여 수단 -> 인내력을 높임
현재 모습을 구체적으로 보게함 -> 목표를 통해 준거점 파악
4 낮은 난이도에서 높은 난이도로 공부
큰 틀에서 핵심 아이디어에 익숙-> 세부사항에 집중
공부한 부분을 에세이 형식으로 요약
광범위하게 요약
+완공 기대수준을 낮춰 작은 성공에 도전
5 낮잠 많이
2.5시간 공부, 휴식을 취하고 무언가를 섭취
아무 생각없이 무언가를 해라. 그다음 낮잠을 자라.
-> 기분을 새롭게하고 공부한 것을 기억할 확률을 증가시킨다.
잠자는 것은 메모리를 통합하는데 도움이 된다.
+완공 낮잠 : 아침에 일어난 후 7~8시간 후 적당. 30분 넘기지 않게
뇌를 사용하면 아데노신이 뇌에 달라붙는다. 쌓이면 피곤함을 느낌. 
이때 
 낮잠을 자면 아데노신이 사라진다 -> 개운해짐
6 2.5시간동안 한 주제를 공부. 그 다음 다른것으로 전환. 반복
7 책을 읽고 내려놓고 읽은 것을 요약. 
읽은 내용을 보지말고 요약
기억하는 연습을 해야 잘 기억할 수 있다.
자료를 보고 복습하는건 아무 소용이 없다.
 작업의 실제적인 어려움 없이 일하는것
불필요하고 스스로 혼란하게 하는 어떤것에도 강조표시하거나 밑줄을 긋지마라.
+완공 어렵게 공부하면 잊기가 어렵다. 
요약 = 인출효과( 장기기억을 위한 공부 전략)
요약, 암송, 토론, 발표, 글쓰기
공부한 내용을 어떻게든 밖으로 표출하는 것. -> 매우 힘든작업 
->뇌가 변하고 장기기억이 형성됨

책상에만 앉아 꼼짝않고 책만 보는 것은 공부 하수가 하는 일.

오늘부터 당장 적용해봐야겠습니다. 저는 최하수였군요.

제대로 된 공부 방법에 관한 7가지 조언

* 어떻게 해야 하루에 10시간 이상 공부를 할 수 있을까요?
- 하루에 10시간 이상 공부할 수 없고, 시도해서도 안된다고 생각한다. 사람이 하루에 3시간 이상 집중하는 것은 매우 드물다. 최대 집중 시간은 3시간이다.

† 꾸준하고 제대로 된 공부법은 무엇인가? 7가지를 소개 †
① 하루에 7.5시간 이상 공부하지 마세요. 
- 더 한다고 해도 더 이상 도움이 되지 않습니다.
- 당신은 지쳤을 때 더 배울 수 없습니다.

② 일주일에 하루는 쉬어라
- 그날은 당신이 좋아하는 것을 해라
- 당신의 일은 배움을 위한 것이지. 일찍 죽기 위한 것이 아니다.
- 인생은 장기전이다. 100m와 42km 마라톤은 다르다.

③ 공부하기 전에 계획을 세워라
- 각 과목에서 가장 중요한 지식이 무엇인지 파악하고 그것에 우선 집중해라
- 각 학습영역에서 가장 빠르고, 쉽게 50%를 얻을 계획이라고 상상해 계획을 세워라
=> 목표 : 내가 무엇을 해야 하는지 제대로 알려준다. 행동을 어떻게 해야 하는지 구체화해주며, 동기부여 수단이 된다. 현재의 모습을 구체적으로 파악이 가능하게 한다.  

④ 낮은 난이도에서 높은 난이도로 공부
- 큰 틀에서 핵심 아이디어에 익숙해진 다음 세부사항에 집중해라
- 실패가 누적되면 성공에 대한 기대를 잃어버린다. 그러므로 작은 성공이 중요하다.
ex) 40명중 40등이다. 목표를 5등으로 했을 때, 작은 성공의 계획을 세우자. 목표 30-20-10-5

⑤  낮잠
- 2.5시간 공부해라
- 휴식을 취하다가 무언가를 먹어라
- 심슨 에피소드를 보는 것처럼 아무 생각없이 무언가를 하십시오.
- 그런 다음 낮잠을 자십시오.
- 그것은 당신의 기분을 새롭게 하고, 당신이 공부한 것을 기억할 확률을 증가시킵니다.
- 잠자는 것은 메모리를 통합하는 데 도움이 되니다.
- 30분을 넘기지 않는 것이 좋다. 

⑥ 2.5 시간동안 한 주제를 공부하십시오.
- 그런 다음 다른 것으로 전환하십시오.
- 이어서 계속 반복하십시오.

⑦ 요약
- 책을 읽고 책을 내려 놓고 읽은 것을 요약하십시오.
- 요약할 때는 읽은 내용을 보지 말고 하십시오.
- 동일한 자료를 반복적으로 보지 않으면서 기억해 내는 연습을 해야만 합니다.
- 당신은 기억하는 연습을 해야 합니다. 그게 당신을 잘 기억하게 만듭니다.
...
## 교수님 체크
인간성/능력/인맥/연구페이퍼/졸업생이 뭐하는가?
"현재 어떤 회사와 연구를 진행중 인지, " 
"연구실 졸업자가 대부분 어디로 취업했는지" 
"연구한 논문 or 분야의 시장성"
...
3 essential job-search strategies for international students - derrek loosvelt
...
손정의 “순익 52조에 만족 안해… AI 스타트업에 집중 투자”
https://news.naver.com/main/read.nhn?mode=LSD&mid=shm&sid1=105&oid=023&aid=0003614132

<strong>“비전을 공유할 수 있고, 첨단 기술에 대한 지식이 있으면서 금융도 이해해야 한다”고 밝혔다.</strong>

https://woman.donga.com/3/all/12/129970/1
이건희 삼성그룹 회장의 ‘천재론&창의성 키우기’ 단독 인터뷰
제품개발, 기획, 마케팅, 구매

"우린 쓰레기" 농담에 파산…운명을 바꾼 부자의 한마디 [부터뷰]
https://news.naver.com/main/ranking/read.nhn?mode=LSD&mid=shm&sid1=001&oid=215&aid=0000956363&rankingType=RANKING
...
1. Embedded SW (이것만 PL법 개정안에 포함 예상)
2. Application

SW 설계상 결함을 인정받으려면 대체 설계를 어떻게 해야 했을지, 
이를 실제 적용했더라면 피해를 막을 수 있었을지 등에 대한 검토가 이뤄져야 하는데 현실적으로 쉽지 않다
(코드 한줄한줄 점걸할 기술자가 필요. 기업에서 코드 및 설계도 공개 안할 가능설 높음.)
...
(AI 기술 발전과 SW 에 대한 제조물 책임 적용이 무슨 관련이 있는지, 왜 불가피한지 모르겠음) 

SW가 마이크로칩이나 특정 디바이스에 임베디드(내장)된 경우 제조물성을 인정하는 견해가 유력

이용자 개별 피해 규모를 어떻게 산정할 것인지
